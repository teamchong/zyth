...
| Benchmark | PyAOT | Python | Speedup |
|:---|---:|---:|---:|
...
|:---|---:|---:|---:|---:|
| **PyAOT (compiled)** | 28.2 ms | 26.8 ms | 30.9 ms | **1.00x** (baseline) |
| Python (CPython) | 804.5 ms | 800.3 ms | 809.7 ms | 28.56x slower |

### Summary

🚀 **PyAOT is 28.56x faster than Python for recursive fibonacci**
...
| Engine | Mean | Min | Max | Relative |
|:---|---:|---:|---:|---:|
| **PyAOT (compiled)** | 1.9 ms | 0.9 ms | 4.3 ms | **1.00x** (baseline) |
| Python (CPython) | 23.6 ms | 21.3 ms | 44.3 ms | 12.24x slower |

### Summary

⚡ **PyAOT is 12.24x faster than Python for string concatenation**
